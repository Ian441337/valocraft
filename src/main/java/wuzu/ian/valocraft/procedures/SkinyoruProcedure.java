...
public class SkinyoruProcedure {
	@OnlyIn(Dist.CLIENT)
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, Entity entity) {
		if (entity == null)
			return;
		if ((entity.getPersistentData().getString("agent")).equals("yoru")) {
			...
			if (_evt.getRenderer() instanceof PlayerRenderer && !(_evt.getRenderer() instanceof com.kleiders.kleidersplayerrenderer.KleidersIgnoreCancel)) {
				...
				if (ResourceLocation.tryParse("valocraft:textures/entities/yoru.png") != null) {
					_texture = new ResourceLocation("valocraft:textures/entities/yoru.png");
				}

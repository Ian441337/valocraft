...
import wuzu.ian.valocraft.init.ValocraftModBlocks;
...
@Mod("valocraft")
public class ValocraftMod {
	public static final Logger LOGGER = LogManager.getLogger(ValocraftMod.class);
	public static final String MODID = "valocraft";
	...
	public ValocraftMod() {
		...
		ValocraftModBlocks.REGISTRY.register(bus);
						...
						for (Field field : fields) {
							if (EditBox.class.isAssignableFrom(field.getType())) {
								try {
									...
									ValocraftMod.LOGGER.error(exceptionAsString);
								}
							}
						}
					}
	...
	public static class initer {
		...
		public static void init(FMLCommonSetupEvent event) {
			ValocraftMod.addNetworkMessage(TextboxSetMessage.class, TextboxSetMessage::buffer, TextboxSetMessage::new, TextboxSetMessage::handler);
		}
	}

...
public class ValorantCommand {
	...
	public static void registerCommand(RegisterCommandsEvent event) {
		event.getDispatcher()
				.register(Commands.literal("valorant").requires(s -> s.hasPermission(4)).then(Commands.argument("name", MessageArgument.message()).then(Commands.argument("arguments", StringArgumentType.greedyString()).executes(arguments -> {
